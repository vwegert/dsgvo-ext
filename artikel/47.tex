...
\begin{enumerate}
  ...
  \item Die zuständige \hyperref[itm:04-21]{Aufsichtsbehörde} genehmigt gemäß dem Kohärenzverfahren nach \hyperref[ch:63]{Artikel 63}
   \hyperref[itm:04-20]{verbindliche interne Datenschutzvorschriften}, sofern diese
  \label{itm:47-1}

  \begin{enumerate}
  
    \item rechtlich bindend sind, für alle betreffenden Mitglieder der \hyperref[itm:04-19]{Unternehmensgruppe} oder einer Gruppe von
     \hyperref[itm:04-18]{Unternehmen}, die eine gemeinsame Wirtschaftstätigkeit ausüben, gelten und von diesen Mitgliedern durchgesetzt
  ...
  \begin{enumerate}
    ...
    \item Struktur und Kontaktdaten der \hyperref[itm:04-19]{Unternehmensgruppe} oder Gruppe von \hyperref[itm:04-18]{Unternehmen}, die eine gemeinsame
    ...
    \item die von dem in einem Mitgliedstaat niedergelassenen \hyperref[itm:04-7]{Verantwortlichen} oder Auftragsverarbeiter übernommene
    ...
    \item die Aufgaben jedes gemäß \hyperref[ch:37]{Artikel 37} benannten Datenschutzbeauftragten oder jeder anderen
     ...
     in der \hyperref[itm:04-19]{Unternehmensgruppe} oder Gruppe von \hyperref[itm:04-18]{Unternehmen}, die eine gemeinsame Wirtschaftstätigkeit ausüben, sowie mit
    ...
    \item die innerhalb der \hyperref[itm:04-19]{Unternehmensgruppe} oder Gruppe von \hyperref[itm:04-18]{Unternehmen}, die eine gemeinsame Wirtschaftstätigkeit
     ...
     einer \hyperref[itm:04-19]{Unternehmensgruppe} oder der Gruppe von \hyperref[itm:04-18]{Unternehmen}, die eine gemeinsame Wirtschaftstätigkeit ausüben,
     mitgeteilt werden und sollten der zuständigen \hyperref[itm:04-21]{Aufsichtsbehörde} auf Anfrage zur Verfügung gestellt werden;
    \label{itm:47-2j}
    ...
    \item die Verfahren für die Zusammenarbeit mit der \hyperref[itm:04-21]{Aufsichtsbehörde}, die die Befolgung der Vorschriften durch
     sämtliche Mitglieder der \hyperref[itm:04-19]{Unternehmensgruppe} oder Gruppe von \hyperref[itm:04-18]{Unternehmen}, die eine gemeinsame Wirtschaftstätigkeit
     ausüben, gewährleisten, insbesondere durch Offenlegung der Ergebnisse von Überprüfungen der unter \hyperref
     [itm:47-2j]{Buchstabe j} genannten Maßnahmen gegenüber der \hyperref[itm:04-21]{Aufsichtsbehörde};
    \label{itm:47-2l}

    \item die Meldeverfahren zur Unterrichtung der zuständigen \hyperref[itm:04-21]{Aufsichtsbehörde} über jegliche für ein Mitglied der
     \hyperref[itm:04-19]{Unternehmensgruppe} oder Gruppe von \hyperref[itm:04-18]{Unternehmen}, die eine gemeinsame Wirtschaftstätigkeit ausüben, in einem
  ...
  \item Die Kommission kann das Format und die Verfahren für den Informationsaustausch über \hyperref[itm:04-20]{verbindliche interne
   Datenschutzvorschriften} im Sinne des vorliegenden Artikels zwischen \hyperref[itm:04-7]{Verantwortlichen}, Auftragsverarbeitern und
   \hyperref[itm:04-21]{Aufsichtsbehörden} festlegen. Diese Durchführungsrechtsakte werden gemäß dem Prüfverfahren nach \hyperref[itm:93-2]
