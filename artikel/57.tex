...
\label{itm:57-1}
  ...
  \begin{enumerate}
    ...
    \item auf Anfrage jeder betroffenen Person Informationen über die Ausübung ihrer Rechte aufgrund dieser Verordnung
     zur Verfügung stellen und gegebenenfalls zu diesem Zweck mit den Aufsichtsbehörden in anderen Mitgliedstaaten
     zusammenarbeiten;
    \label{itm:57-1e}

    \item sich mit Beschwerden einer betroffenen Person oder Beschwerden einer Stelle, einer Organisation oder eines
    ...
    \item maßgebliche Entwicklungen verfolgen, soweit sie sich auf den Schutz personenbezogener Daten auswirken,
    ...
    \item jede sonstige Aufgabe im Zusammenhang mit dem Schutz personenbezogener Daten erfüllen.
    \label{itm:57-1v}
  ...
  \item Die Erfüllung der Aufgaben jeder Aufsichtsbehörde ist für die betroffene Person und gegebenenfalls für den
