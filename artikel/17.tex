...
\begin{enumerate}
  ...
  \item Die \hyperref[itm:04-1]{betroffene Person} hat das Recht, von dem \hyperref[itm:04-7]{Verantwortlichen} zu verlangen, dass sie betreffende
   \hyperref[itm:04-1]{personenbezogene Daten} unverzüglich gelöscht werden, und der \hyperref[itm:04-7]{Verantwortliche} ist verpflichtet, personenbezogene
  ...
  \begin{enumerate}
    ...
    \item Die \hyperref[itm:04-1]{betroffene Person} widerruft ihre \hyperref[itm:04-11]{Einwilligung}, auf die sich die \hyperref[itm:04-2]{Verarbeitung} gemäß \hyperref[itm:06-1a]
    ...
    \item Die Löschung der \hyperref[itm:04-1]{personenbezogenen Daten} ist zur Erfüllung einer rechtlichen Verpflichtung nach dem
     Unionsrecht oder dem Recht der Mitgliedstaaten erforderlich, dem der \hyperref[itm:04-7]{Verantwortliche} unterliegt.
    \label{itm:17-1e}
  ...
  \item Hat der \hyperref[itm:04-7]{Verantwortliche} die \hyperref[itm:04-1]{personenbezogenen Daten} öffentlich gemacht und ist er gemäß \hyperref[itm:17-1]
   {Absatz 1} zu deren Löschung verpflichtet, so trifft er unter Berücksichtigung der verfügbaren Technologie und der
   Implementierungskosten angemessene Maßnahmen, auch technischer Art, um für die Datenverarbeitung \hyperref[itm:04-7]{Verantwortliche},
  ...
  \begin{enumerate}
    ...
    \item zur Erfüllung einer rechtlichen Verpflichtung, die die \hyperref[itm:04-2]{Verarbeitung} nach dem Recht der Union oder der
     Mitgliedstaaten, dem der \hyperref[itm:04-7]{Verantwortliche} unterliegt, erfordert, oder zur Wahrnehmung einer Aufgabe, die im
     öffentlichen Interesse liegt oder in Ausübung öffentlicher Gewalt erfolgt, die dem \hyperref[itm:04-7]{Verantwortlichen} übertragen
     wurde;
    \label{itm:17-3b}
