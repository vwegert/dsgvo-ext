...
\begin{enumerate}
  ...
  \item Diese Verordnung enthält Vorschriften zum Schutz natürlicher Personen bei der \hyperref[itm:04-2]{Verarbeitung} \hyperref[itm:04-1]
  ...
  \item Der freie Verkehr \hyperref[itm:04-1]{personenbezogener Daten} in der Union darf aus Gründen des Schutzes
   natürlicher Personen bei der \hyperref[itm:04-2]{Verarbeitung} \hyperref[itm:04-1]{personenbezogener Daten} weder eingeschränkt noch
   verboten werden.
  \label{itm:01-3}
