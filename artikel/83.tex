...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item etwaige einschlägige frühere Verstöße des \hyperref[itm:04-7]{Verantwortlichen} oder des Auftragsverarbeiters;
    \label{itm:83-2e}
    ...
    \item Art und Weise, wie der Verstoß der \hyperref[itm:04-21]{Aufsichtsbehörde} bekannt wurde, insbesondere ob und gegebenenfalls in
     welchem Umfang der \hyperref[itm:04-7]{Verantwortliche} oder der Auftragsverarbeiter den Verstoß mitgeteilt hat;
    \label{itm:83-2h}

    \item Einhaltung der nach \hyperref[itm:58-2]{Artikel 58 Absatz 2} früher gegen den für den betreffenden
     \hyperref[itm:04-7]{Verantwortlichen} oder Auftragsverarbeiter in Bezug auf denselben Gegenstand angeordneten Maßnahmen, wenn solche
  ...
  \item Verstößt ein \hyperref[itm:04-7]{Verantwortlicher} oder ein Auftragsverarbeiter bei gleichen oder miteinander verbundenen
