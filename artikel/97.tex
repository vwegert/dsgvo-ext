...
\begin{enumerate}
  ...
  \item Bis zum 25. Mai 2020 und danach alle vier Jahre legt die Kommission dem Europäischen Parlament und dem Rat einen
   ...
   \comment{Der erste dieser Berichte ist unter \cite{bericht-art97-2020} verfügbar.}%
  \label{itm:97-1}
  ...
  \begin{enumerate}
    ...
    \item des \hyperref[part:5]{Kapitels V} über die Übermittlung \hyperref[itm:04-1]{personenbezogener Daten} an
     ...
     Artikel 25 Absatz 6 der Richtlinie 95/46/EG\comment{Richtlinie 95/46/EG \cite{ril-ds-alt} wird durch die DSGVO
     ersetzt (vgl. \hyperref[ch:94]{Artikel 94}). Artikel 25 Absatz 6 der Richtlinie erlaubt der Kommission
     festzustellen, dass ein Drittland aufgrund innerstaatlicher Rechtsvorschriften oder internationaler Verpflichten
     ein angemessenes Schutzniveau bietet.} erlassenen Feststellungen,%
    \label{itm:97-2a}
