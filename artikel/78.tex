...
\begin{enumerate}
  ...
  \item Kommt es zu einem Verfahren gegen den Beschluss einer \hyperref[itm:04-21]{Aufsichtsbehörde}, dem eine
   Stellungnahme oder ein Beschluss des \hyperref[ch:68]{Ausschusses} im Rahmen des Kohärenzverfahrens vorangegangen ist, so leitet
