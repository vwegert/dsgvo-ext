...
\begin{enumerate}
  ...
  \item Der \hyperref[itm:04-17]{Vertreter} muss in einem der Mitgliedstaaten niedergelassen sein, in denen die \hyperref[itm:04-1]{betroffenen Personen}, deren
  ...
  \item Der \hyperref[itm:04-17]{Vertreter} wird durch den \hyperref[itm:04-7]{Verantwortlichen} oder den \hyperref[itm:04-8]{Auftragsverarbeiter} beauftragt, zusätzlich zu diesem oder
  ...
  \item Die Benennung eines \hyperref[itm:04-17]{Vertreters} durch den \hyperref[itm:04-7]{Verantwortlichen} oder den \hyperref[itm:04-8]{Auftragsverarbeiter} erfolgt unbeschadet
