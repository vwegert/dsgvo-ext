...
\begin{enumerate}
  ...
  \item Hat eine \hyperref[itm:04-21]{Aufsichtsbehörde} eine Maßnahme nach \hyperref[itm:66-1]{Absatz 1} ergriffen und
   ...
   im Dringlichkeitsverfahren um eine Stellungnahme oder einen verbindlichen Beschluss des Ausschusses ersuchen.%
  \label{itm:66-2}
  ...
  \item Jede \hyperref[itm:04-21]{Aufsichtsbehörde} kann unter Angabe von Gründen, auch für den dringenden
   ...
   des Ausschusses ersuchen, wenn eine zuständige \hyperref[itm:04-21]{Aufsichtsbehörde} trotz dringenden
