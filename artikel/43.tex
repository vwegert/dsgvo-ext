...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item der nationalen Akkreditierungsstelle, die gemäß der Verordnung (EG) Nr. 765/2008\comment{Die Verordnung \cite
     {vo-akkred-2008} (geändert durch \cite{vo-mu-kp-2019}, konsolidierte Fassung unter \cite{vo-akkred-kons}) legt
     generelle Prinzipien der Akkreditierung und gegenseitigen Anerkennung fest.} des Europäischen Parlaments und des
     Rate im Einklang mit EN-ISO/IEC 17065/2012\comment{Die Norm EN-ISO/IEC 17065/2012 (nicht kostenfrei verfügbar)
     legt Anforderungen an Stellen, die Produkte, Prozesse und Dienstleistungen zertifizieren fest.} und mit den
  ...
  \item Die Akkreditierung von Zertifizierungsstellen nach den Absätzen \hyperref[itm:43-1]{1} und \hyperref[itm:43-2]
   ...
   Ausschuss\comment{Stellungnahme siehe \hyperref[itm:64-1c]{Artikel 64 Absatz 1 Buchstabe c}} genehmigt wurden. Im
   Fall einer Akkreditierung nach \hyperref[itm:43-1b]{Absatz 1 Buchstabe b des
   vorliegenden Artikels} ergänzen diese Anforderungen diejenigen, die in der Verordnung (EG) Nr. 765/2008 und in den
