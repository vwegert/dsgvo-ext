...
\begin{enumerate}
  ...
  \item Falls weder ein Angemessenheitsbeschluss nach \hyperref[itm:45-3]{Artikel 45 Absatz 3} vorliegt noch geeignete
   ...
   Datenschutzvorschriften}, bestehen,\comment{Leitlinien, Empfehlungen und bewährte Verfahren des Ausschusses
   siehe \hyperref[itm:70-1j]{Artikel 70 Absatz 1 Buchstabe j}} ist eine Übermittlung oder eine Reihe von
   Übermittlungen \hyperref[itm:04-1]{personenbezogener Daten} an ein Drittland oder an eine \hyperref[itm:04-26]
   {internationale Organisation} nur unter einer der folgenden Bedingungen zulässig:%
  \label{itm:49-1-1}
  ...
  \phantomsection Falls die Übermittlung nicht auf eine Bestimmung der Artikel \hyperref[ch:45]{45} oder \hyperref
   ...
   eine Übermittlung an ein Drittland oder eine \hyperref[itm:04-26]{internationale Organisation} nur dann erfolgen,
  ...
  \hyperref[itm:04-7]{Verantwortlichen} erforderlich ist, sofern die Interessen oder die Rechte und Freiheiten
   ...
   Umstände der Datenübermittlung beurteilt und auf der Grundlage dieser Beurteilung geeignete Garantien
   \comment{Dokumentation der Garantien im Verzeichnis der Verarbeitungstätigkeiten notwendig, siehe \hyperref
    [itm:30-1e]{Artikel 30 Absatz 1 Buchstabe e} und \hyperref[itm:30-2c]{Absatz 2 Buchstabe c}} in Bezug auf den
    Schutz \hyperref[itm:04-1]{personenbezogener Daten} vorgesehen hat. Der \hyperref[itm:04-7]{Verantwortliche} setzt
    die \hyperref[itm:04-21]{Aufsichtsbehörde} von der Übermittlung in Kenntnis. Der \hyperref[itm:04-7]
    {Verantwortliche} unterrichtet die \hyperref[itm:04-1]{betroffene Person} über die Übermittlung und seine
  ...
  \item Liegt kein Angemessenheitsbeschluss vor, so können im Unionsrecht oder im Recht der Mitgliedstaaten aus
   ...
   von
   \hyperref[itm:04-1]{personenbezogenen Daten} an Drittländer oder \hyperref[itm:04-26]{internationale Organisationen}
