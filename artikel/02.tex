...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item durch die Mitgliedstaaten im Rahmen von Tätigkeiten, die in den Anwendungsbereich von Titel V Kapitel 2
     EUV\comment{Titel V Kapitel 2 EUV \cite{euv} bezieht sich auf die gemeinsame Außen- und Sicherheitspolitik der
     EU"=Mitgliedsstaaten.} fallen,
    \label{itm:02-2b}
  ...
  \item Für die \hyperref[itm:04-2]{Verarbeitung} \hyperref[itm:04-1]{personenbezogener Daten} durch die Organe,
   Einrichtungen, Ämter und Agenturen der Union gilt die Verordnung (EG) Nr. 45/2001.\comment{Die Verordnung (EG) Nr.
   45/2001 \cite{vo-ds-fdv} hat den Schutz natürlicher Personen bei der Verarbeitung personenbezogener Daten durch die
   Organe und Einrichtungen der Gemeinschaft und den freien Datenverkehr zum Inhalt.} Die Verordnung (EG) Nr. 45/2001
  ...
  \item Die vorliegende Verordnung lässt die Anwendung der Richtlinie 2000/31/EG\comment{Die Richtlinie 2000/31/EG \cite
   {ril-egv} regelt bestimmte rechtliche Aspekte der Dienste der Informationsgesellschaft, insbesondere des
   elektronischen Geschäftsverkehrs, im Binnenmarkt. Die referenzierten Artikel betreffen die Themenkomplexe \emph
   {Reine Durchleitung} (Artikel 12), \emph{Caching}(Artikel 13), \emph{Hosting} (Artikel 14) und \emph
   {Keine allgemeine Überwachungspflicht} (Artikel 15).} und speziell die Vorschriften der Artikel 12 bis 15 dieser
