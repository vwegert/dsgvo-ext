...
\begin{itemize}
  ...
  \item Der Verweis auf Titel V Kapitel 2 EUV \cite{euv} in \hyperref[itm:02-2a]{Absatz 2a} bezieht sich auf die
   gemeinsame Außen- und Sicherheitspolitik der EU"=Mitgliedsstaaten.

  \item Die Verordnung (EG) Nr. 45/2001 \cite{vo-ds-fdv} in \hyperref[itm:02-3]{Absatz 3} hat den Schutz natürlicher
   Personen bei der Verarbeitung personenbezogener Daten durch die Organe und Einrichtungen der Gemeinschaft und den
   freien Datenverkehr zum Inhalt.

  \item Die in \hyperref[itm:02-4]{Absatz 4} referenzierte Richtlinie 2000/31/EG \cite{ril-egv} regelt bestimmte
