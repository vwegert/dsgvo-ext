...
\begin{enumerate}
  ...
  Mit Blick auf \hyperref[itm:28-1h]{Unterabsatz 1 Buchstabe h} informiert der Auftragsverarbeiter den Verantwortlichen
  ...
  \item Nimmt der Auftragsverarbeiter die Dienste eines weiteren Auftragsverarbeiters in Anspruch, um bestimmte
   ...
   dem Verantwortlichen und dem Auftragsverarbeiter gemäß \hyperref[itm:28-3]{Absatz 3} festgelegt sind, wobei
  ...
  \item Unbeschadet eines individuellen Vertrags zwischen dem Verantwortlichen und dem Auftragsverarbeiter kann der
   Vertrag oder das andere Rechtsinstrument im Sinne der Absätze \hyperref[itm:28-3]{3} und \hyperref[itm:28-4]{4} des
  ...
  \item Die Kommission kann im Einklang mit dem Prüfverfahren gemäß \hyperref[itm:87-2]{Artikel 87 Absatz 2}
   Standardvertragsklauseln zur Regelung der in den Absätzen \hyperref[itm:28-3]{3} und \hyperref[itm:28-4]{4} des
  ...
  \item Der Vertrag oder das andere Rechtsinstrument im Sinne der Absätze \hyperref[itm:28-3]{3} und \hyperref[itm:28-4]
