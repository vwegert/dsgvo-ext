...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item die \hyperref[itm:04-9]{Empfänger} oder Kategorien von \hyperref[itm:04-9]{Empfängern}, gegenüber denen die \hyperref[itm:04-1]{personenbezogenen Daten} offengelegt worden
     sind oder noch offengelegt werden, insbesondere bei \hyperref[itm:04-9]{Empfängern} in Drittländern oder bei internationalen
     Organisationen;
    \label{itm:15-1c}
