...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Die betroffene Person hat ihre Einwilligung zu der Verarbeitung der sie betreffenden \hyperref[itm:04-1]{personenbezogenen Daten}
    ...
    \item die Verarbeitung ist zur Wahrung der berechtigten Interessen des Verantwortlichen oder eines Dritten
     ...
     Schutz \hyperref[itm:04-1]{personenbezogener Daten} erfordern, überwiegen, insbesondere dann, wenn es sich bei der betroffenen Person
     um ein Kind handelt.
    \label{itm:06-1f}
