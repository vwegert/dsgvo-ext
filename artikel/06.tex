...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Die \hyperref[itm:04-1]{betroffene Person} hat ihre \hyperref[itm:04-11]{Einwilligung}\comment{\hyperref[ch:7]
     {Artikel 7} beachten; Einwilligung als Verarbeitungsgrundlage führt bei automatisierten Verfahren zu Recht auf
     Datenübertragbarkeit nach \hyperref[itm:20-1]{Artikel 20 Absatz 1}} zu der \hyperref[itm:04-2]{Verarbeitung} der
     sie betreffenden \hyperref[itm:04-1]{personenbezogenen Daten} für einen oder mehrere bestimmte Zwecke gegeben;%
    \label{itm:06-1a}

    \item die \hyperref[itm:04-2]{Verarbeitung} ist für die Erfüllung eines Vertrags\comment{Vertrag als
     Verarbeitungsgrundlage führt bei automatisierten Verfahren zu Recht auf Datenübertragbarkeit nach \hyperref
     [itm:20-1]{Artikel 20 Absatz 1}}, dessen Vertragspartei die \hyperref[itm:04-1]{betroffene Person} ist, oder zur
    ...
    \item die \hyperref[itm:04-2]{Verarbeitung} ist für die Wahrnehmung einer Aufgabe erforderlich, die im öffentlichen
     Interesse liegt\comment{Widerspruchsrecht nach \hyperref[itm:21-1]{Artikel 21 Absatz 1} beachten} oder in Ausübung
     öffentlicher Gewalt erfolgt, die dem \hyperref[itm:04-7]{Verantwortlichen} übertragen wurde;%
    \label{itm:06-1e}

    \item die \hyperref[itm:04-2]{Verarbeitung} ist zur Wahrung der berechtigten Interessen\comment{Interessen müssen
     der betroffenen Person mitgeteilt werden, vgl. \hyperref[itm:13-1d]{Artikel 13 Absatz 1 Buchstabe d}
     bzw. \hyperref[itm:14-2b]{Artikel 14 Absatz 2 Buchstabe b}; Widerspruchsrecht nach \hyperref[itm:21-1]{Artikel 21
     Absatz 1} beachten}  des \hyperref[itm:04-7]{Verantwortlichen} oder eines \hyperref[itm:04-10]
