...
\begin{enumerate}
  ...
  \item Die \hyperref[itm:04-21]{Aufsichtsbehörde} erstellt eine Liste der Verarbeitungsvorgänge\comment{Die Listen des
   BFdI und der DSK sind unter \cite{bfdi-dsfa-listen} zu finden.}, für die gemäß \hyperref[itm:35-1]{Absatz 1} eine
   ...
   \comment{Stellungnahme siehe \hyperref[itm:64-1a]{Artikel 64 Absatz 1 Buchstabe a}}%
  \label{itm:35-4}
