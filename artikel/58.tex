...
\crossrefArticleToReason{58}

\begin{enumerate}

  \item Jede \hyperref[itm:04-21]{Aufsichtsbehörde}\comment{Leitlinien des Ausschusses zur Anwendung von Maßnahmen siehe
  \hyperref[itm:70-1k]{Artikel 70 Absatz 1 Buchstabe k}} verfügt über sämtliche folgenden Untersuchungsbefugnisse, die
  es ihr gestatten,%
  \label{itm:58-1}
  ...
  \begin{enumerate}
    ...
    \item die Aussetzung der Übermittlung von Daten an einen \hyperref[itm:04-9]{Empfänger} in einem Drittland oder an
     eine \hyperref[itm:04-26]{internationale Organisation} anzuordnen.%
    \label{itm:58-2j}
