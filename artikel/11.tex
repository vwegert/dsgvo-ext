...
\begin{enumerate}
  ...
  \item Ist für die Zwecke, für die ein \hyperref[itm:04-7]{Verantwortlicher} \hyperref[itm:04-1]{personenbezogene Daten} verarbeitet, die Identifizierung der
   \hyperref[itm:04-1]{betroffenen Person} durch den \hyperref[itm:04-7]{Verantwortlichen} nicht oder nicht mehr erforderlich, so ist dieser nicht verpflichtet,
  ...
  \item Kann der \hyperref[itm:04-7]{Verantwortliche} in Fällen gemäß \hyperref[itm:11-1]{Absatz 1} des vorliegenden Artikels nachweisen,
