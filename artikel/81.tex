...
\begin{enumerate}
  ...
  \item Erhält ein zuständiges Gericht in einem Mitgliedstaat Kenntnis von einem Verfahren zu demselben Gegenstand in
   Bezug auf die \hyperref[itm:04-2]{Verarbeitung} durch denselben \hyperref[itm:04-7]{Verantwortlichen} oder \hyperref[itm:04-8]{Auftragsverarbeiter}, das vor einem Gericht in einem
  ...
  \item Ist ein Verfahren zu demselben Gegenstand in Bezug auf die \hyperref[itm:04-2]{Verarbeitung} durch denselben \hyperref[itm:04-7]{Verantwortlichen} oder
   \hyperref[itm:04-8]{Auftragsverarbeiter} vor einem Gericht in einem anderen Mitgliedstaat anhängig, so kann jedes später angerufene
