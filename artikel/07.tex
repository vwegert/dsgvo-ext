...
\crossrefArticleToReason{7}

\begin{enumerate}

  \item Beruht die \hyperref[itm:04-2]{Verarbeitung} auf einer \hyperref[itm:04-11]{Einwilligung}\comment{vgl.
  \hyperref[itm:06-1a]{Artikel 6 Absatz 1 Buchstabe a}}, muss der \hyperref
