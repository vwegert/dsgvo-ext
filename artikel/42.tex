...
\begin{enumerate}
  ...
  \item Die Mitgliedstaaten, die \hyperref[itm:04-21]{Aufsichtsbehörden}, der Ausschuss und die Kommission fördern
   ...
   \comment{geeignet zum Nachweis der Pflichterfüllung des Verantwortlichen (\hyperref[itm:24-3]{Artikel 24 Absatz 3}
    und \hyperref[itm:25-3]{Artikel 25 Absatz 3}), hinreichender Garantien des Auftragsverarbeiters (\hyperref
    [itm:28-5]{Artikel 28 Absatz 5}), der Sicherheit der Verarbeitung (\hyperref[itm:32-3]{Artikel 32 Absatz 3}) und
    als Garantien zur Datenübermittlung (\hyperref[itm:46-2f]{Artikel 46 Absatz 2 Buchstabe f})} Den besonderen
  ...
  \item Eine Zertifizierung nach diesem Artikel wird durch die Zertifizierungsstellen nach \hyperref[ch:43]{Artikel 43}
   ...
   \comment{Stellungnahme siehe \hyperref[itm:64-1c]{Artikel 64 Absatz 1 Buchstabe c}}
