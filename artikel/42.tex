...
\begin{enumerate}
  ...
  \item Die Mitgliedstaaten, die \hyperref[itm:04-21]{Aufsichtsbehörden}, der Ausschuss und die Kommission fördern insbesondere auf
   ...
   \hyperref[itm:04-7]{Verantwortlichen} oder Auftragsverarbeitern eingehalten wird. Den besonderen Bedürfnissen von Kleinstunternehmen
  ...
  \item Zusätzlich zur Einhaltung durch die unter diese Verordnung fallenden \hyperref[itm:04-7]{Verantwortlichen} oder Auftragsverarbeiter
   ...
   \hyperref[itm:04-7]{Verantwortlichen} oder Auftragsverarbeiter, die gemäß \hyperref[ch:3]{Artikel 3} nicht unter diese Verordnung
  ...
  \item Der \hyperref[itm:04-7]{Verantwortliche} oder der Auftragsverarbeiter, der die von ihm durchgeführte \hyperref[itm:04-2]{Verarbeitung} dem
  ...
  \item Die Zertifizierung wird einem \hyperref[itm:04-7]{Verantwortlichen} oder einem Auftragsverarbeiter für eine Höchstdauer von drei
