...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Die \hyperref[itm:04-1]{betroffene Person} hat in die \hyperref[itm:04-2]{Verarbeitung} der genannten \hyperref[itm:04-1]{personenbezogenen Daten} für einen oder mehrere
     ...
     kann das Verbot nach \hyperref[itm:09-1]{Absatz 1} durch die \hyperref[itm:04-11]{Einwilligung} der \hyperref[itm:04-1]{betroffenen Person} nicht aufgehoben
     werden,
    \label{itm:09-2a}
    ...
    \item die \hyperref[itm:04-2]{Verarbeitung} ist zum Schutz lebenswichtiger Interessen der \hyperref[itm:04-1]{betroffenen Person} oder einer anderen
     ...
     außerstande, ihre \hyperref[itm:04-11]{Einwilligung} zu geben,
    \label{itm:09-2c}
    ...
    \item die \hyperref[itm:04-2]{Verarbeitung} erfolgt auf der Grundlage geeigneter Garantien durch eine politisch, weltanschaulich,
     ...
     \hyperref[itm:04-1]{personenbezogenen Daten} nicht ohne \hyperref[itm:04-11]{Einwilligung} der \hyperref[itm:04-1]{betroffenen Personen} nach außen offengelegt werden,
    \label{itm:09-2d}
  ...
  \item Die Mitgliedstaaten können zusätzliche Bedingungen, einschließlich Beschränkungen, einführen oder
   aufrechterhalten, soweit die \hyperref[itm:04-2]{Verarbeitung} von \hyperref[itm:04-13]{genetischen}, \hyperref[itm:04-14]{biometrischen} oder \hyperref[itm:04-15]{Gesundheitsdaten}
   betroffen ist.
  \label{itm:09-4}
