...
\begin{enumerate}
  ...
  \item „Profiling“ jede Art der automatisierten Verarbeitung \hyperref[itm:04-1]{personenbezogener Daten}, die darin besteht, dass diese
  ...
  \item „Pseudonymisierung“ die Verarbeitung \hyperref[itm:04-1]{personenbezogener Daten} in einer Weise, dass die \hyperref[itm:04-1]{personenbezogenen Daten}
  ...
  \item „Verantwortlicher“ die natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die allein
   oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von \hyperref[itm:04-1]{personenbezogenen Daten} entscheidet; sind
  ...
  \item „Empfänger“ eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, der
   ...
   Mitgliedstaaten möglicherweise \hyperref[itm:04-1]{personenbezogene Daten} erhalten, gelten jedoch nicht als Empfänger; die Verarbeitung
  ...
  \item „Einwilligung“ der \hyperref[itm:04-1]{betroffenen Person} jede freiwillig für den bestimmten Fall, in informierter Weise und
   ...
   bestätigenden Handlung, mit der die \hyperref[itm:04-1]{betroffene Person} zu verstehen gibt, dass sie mit der Verarbeitung der sie
   betreffenden \hyperref[itm:04-1]{personenbezogenen Daten} einverstanden ist;
  \label{itm:04-11}

  \item „Verletzung des Schutzes \hyperref[itm:04-1]{personenbezogener Daten}“ eine Verletzung der Sicherheit, die, ob unbeabsichtigt oder
  ...
  \item „betroffene Aufsichtsbehörde“ eine Aufsichtsbehörde, die von der Verarbeitung \hyperref[itm:04-1]{personenbezogener Daten} betroffen
   ist, weil
  \label{itm:04-22}
  ...
  \begin{enumerate}
    ...
    \item diese Verarbeitung erhebliche Auswirkungen auf \hyperref[itm:04-1]{betroffene Personen} mit Wohnsitz im Mitgliedstaat dieser
  ...
  \begin{enumerate}
    ...
    \item eine Verarbeitung \hyperref[itm:04-1]{personenbezogener Daten}, die im Rahmen der Tätigkeiten von Niederlassungen eines
    ...
    \item eine Verarbeitung \hyperref[itm:04-1]{personenbezogener Daten}, die im Rahmen der Tätigkeiten einer einzelnen Niederlassung eines
