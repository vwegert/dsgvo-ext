...
\begin{enumerate}
  ...
  \item Die Mitgliedstaaten bringen durch Rechtsvorschriften das Recht auf den Schutz personenbezogener Daten gemäß
  ...
  \item Für die Verarbeitung, die zu journalistischen Zwecken oder zu wissenschaftlichen, künstlerischen oder
   ...
   {Kapitel II} (Grundsätze), \hyperref[part:3]{Kapitel III} (Rechte der betroffenen Person), \hyperref[part:4]
   ...
   Schutz der personenbezogenen Daten mit der Freiheit der Meinungsäußerung und der Informationsfreiheit in Einklang zu
   bringen.
  \label{itm:85-2}
