...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item außergerichtliche Verfahren und sonstige Streitbeilegungsverfahren zur Beilegung von Streitigkeiten zwischen
     Verantwortlichen und \hyperref[itm:04-1]{betroffenen Personen} im Zusammenhang mit der \hyperref[itm:04-2]{Verarbeitung}, unbeschadet der Rechte \hyperref[itm:04-1]{betroffener
