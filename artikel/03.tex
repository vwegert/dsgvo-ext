...
\begin{enumerate}
  ...
  \item Diese Verordnung findet Anwendung auf die \hyperref[itm:04-2]{Verarbeitung} \hyperref[itm:04-1]{personenbezogener Daten}, soweit
   diese im Rahmen der Tätigkeiten einer Niederlassung eines \hyperref[itm:04-7]{Verantwortlichen} oder eines \hyperref[itm:04-8]{Auftragsverarbeiters} in der
  ...
  \item Diese Verordnung findet Anwendung auf die \hyperref[itm:04-2]{Verarbeitung} \hyperref[itm:04-1]{personenbezogener Daten} von
   ...
   \hyperref[itm:04-7]{Verantwortlichen} oder \hyperref[itm:04-8]{Auftragsverarbeiter}, wenn die Datenverarbeitung im Zusammenhang damit steht
  \label{itm:03-2}
